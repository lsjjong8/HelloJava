...
public class MemoryComparison {
    public static void main(String[] args) {
        // 기본 자료형(Primitive Type) : 숫자(int), 문자(char) 등 단순 값을 저장
        int i = 1; // 메모리 번지에 i라는 이름의 라벨링 붙임. 해당 값이 메모리 4 byte 공간에 저장
        float f = 10.f;
        char c = 'A';
        ...
        // String.valueOf() : 객체 생성을 최적화, 정적 팩토리 메서드 패턴, 객체 직접 생성 x, 캡슐화해서 기존 문자열 재사용
        ...
        String str3 = new String("Hello"); // String constant pool 저장
